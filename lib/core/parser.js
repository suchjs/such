...
exports.Dispatcher = exports.AParser = void 0;
var config_1 = require("../data/config");
var utils_1 = require("../helpers/utils");
var AParser = (function () {
    function AParser() {
        this.patterns = [];
        this.code = '';
        this.setting = {
    ...
    AParser.prototype.init = function () {
        return this;
    };
    AParser.prototype.info = function () {
    ...
    AParser.prototype.parseCode = function (code, tags) {
        this.code = code;
        this.tags = tags;
    ...
    AParser.prototype.halt = function (err) {
        throw new Error(err);
    };
    return AParser;
}());
        ...
        while (index < len) {
            ...
            if (exists[type] && instance.setting.frozen) {
                ...
                if (Array.isArray(curResult)) {
                    ...
                    result[type] = __assign(__assign({}, (result[type] || {})), curResult);
                }
                exists[type] = true;
            }
        }
    ...
    Dispatcher.prototype.parseUntilFind = function (context) {
        ...
        if (len) {
            ...
            while (len--) {
                ...
                var rule = parser.rule, separator = parser.separator;
                tryTypes.push(type);
