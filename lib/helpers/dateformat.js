...
exports.dateformat = exports.strtotime = void 0;
...
var strToDate = function (dateStr, baseDate) {
    ...
    if (dateStr === '') {
        ...
        var args = match.slice(1, 4);
        return makeDate.apply(void 0, args);
    }
        ...
        for (var i = 0, j = setFnQueues.length; i < j; i++) {
            ...
            if (num) {
                var orig = lastDate["get" + method]();
                try {
                    lastDate["set" + method](orig + num);
                }
                catch (e) {
                    throw e;
                }
