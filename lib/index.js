...
if (lastConfFile) {
    ...
    if (conf.config) {
        ...
        if (dataDir_1) {
            such_1.default.reloadData = function () {
        ...
        if (preload_1 && dataDir_1) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(utils_1.typeOf(preload_1) === 'Array')) return [3, 1];
                        ...
                        case 4:
                            _a.sent();
                            such_1.default.clearCache = function () {
...
such_1.default.define('dict', dict_1.default);
such_1.default.define('cascader', cascader_1.default);
var origSuchas = such_1.default.as;
such_1.default.as = function (target, options) {
