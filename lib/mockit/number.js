...
var printf_1 = require("../helpers/printf");
...
var ToNumber = (function (_super) {
    ...
    ToNumber.prototype.init = function () {
        ...
        this.addModifier('Format', (function (result, Format) {
            return printf_1.default(Format.format, result);
        }));
    };
    ToNumber.prototype.generate = function (datas, dpath) {
